    ...
    variants: {
      variant: {
        ...
        primary:
          "bg-primary text-primary-foreground hover:bg-primary/90 font-extrabold",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/90 font-extrabold",
        destructive:
        ...
        quiet: "hover:bg-surface-elevated text-muted-foreground hover:text-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        arcade:
          "arcade-btn bg-surface border border-border text-foreground hover:bg-surface-elevated active:scale-95",
      },
      size: {
