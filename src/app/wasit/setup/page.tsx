...
import { Users, Target, Sliders, ArrowRight, CheckCircle2, RotateCcw } from 'lucide-react';
import { PointsConfig } from '@/types/domino';

const SEAT_LABELS = [
  { seat: 1, label: 'Kursi 1 (Merah)', defaultName: 'Maman', border: 'border-rose-500/40 focus:border-rose-500' },
  { seat: 2, label: 'Kursi 2 (Biru)', defaultName: 'Topati', border: 'border-blue-500/40 focus:border-blue-500' },
  { seat: 3, label: 'Kursi 3 (Hijau)', defaultName: 'Fatir', border: 'border-emerald-500/40 focus:border-emerald-500' },
  { seat: 4, label: 'Kursi 4 (Kuning)', defaultName: 'Udin', border: 'border-amber-500/40 focus:border-amber-500' },
];
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2 font-mono text-xs">
              <label className="block text-slate-400 font-bold">TIPE TARGET MATCH</label>
